...
//! HIP segmented argmin dispatch.
//!
//! Returns the absolute index of the minimum element in each segment.
//! Empty segments write -1.
...
/// Defines `HipDtype` — re-exported at the `reduce` module level so sibling
/// modules can import it as `crate::kernels::hip::reduce::HipDtype`.
