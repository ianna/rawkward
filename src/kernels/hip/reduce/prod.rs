...
//! HIP segmented product dispatch.
//!
//! out[seg] = product of all elements in segment.  Empty segments write T(1).
...
pub fn segmented_prod_f32<B: GpuBackend>(
    backend: &B,
    data: &B::DevSlice<f32>,
