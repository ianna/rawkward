...
//! HIP segmented max dispatch.
//!
//! out[seg] = maximum element in segment.  Empty segments return the type's
//! lowest representable value (matching the C++ kernel behaviour).
...
pub fn segmented_max_f32<B: GpuBackend>(
    backend: &B,
    data: &B::DevSlice<f32>,
...
pub fn segmented_max_f64<B: GpuBackend>(
    backend: &B,
    data: &B::DevSlice<f64>,
    offsets: &B::DevSlice<i64>,
...
pub fn segmented_max_i32<B: GpuBackend>(
    backend: &B,
    data: &B::DevSlice<i32>,
    offsets: &B::DevSlice<i64>,
...
pub fn segmented_max_i64<B: GpuBackend>(
    backend: &B,
    data: &B::DevSlice<i64>,
    offsets: &B::DevSlice<i64>,
