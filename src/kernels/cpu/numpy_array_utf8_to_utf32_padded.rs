...
pub fn numpy_array_utf8_to_utf32_padded_int32(fromptr: &[u8], fromoffsets: &[i32], offsetslength: usize, maxcodepoints: usize, toptr: &mut [u32]) -> Result<(), KernelError> {
    numpy_array_utf8_to_utf32_padded(fromptr, fromoffsets, offsetslength, maxcodepoints, toptr)
}
pub fn numpy_array_utf8_to_utf32_padded_uint32(fromptr: &[u8], fromoffsets: &[u32], offsetslength: usize, maxcodepoints: usize, toptr: &mut [u32]) -> Result<(), KernelError> {
    numpy_array_utf8_to_utf32_padded(fromptr, fromoffsets, offsetslength, maxcodepoints, toptr)
}
pub fn numpy_array_utf8_to_utf32_padded_int64(fromptr: &[u8], fromoffsets: &[i64], offsetslength: usize, maxcodepoints: usize, toptr: &mut [u32]) -> Result<(), KernelError> {
    numpy_array_utf8_to_utf32_padded(fromptr, fromoffsets, offsetslength, maxcodepoints, toptr)
}
